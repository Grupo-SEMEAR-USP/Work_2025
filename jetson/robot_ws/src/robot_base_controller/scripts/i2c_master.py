...
class I2CCommunication:
    ...
    def read_data(self):
        try:
            ...
            #print(self.encoder_msg.front_left_encoder_data, self.encoder_msg.front_right_encoder_data, self.encoder_msg.rear_left_encoder_data, self.encoder_msg.rear_right_encoder_data)
