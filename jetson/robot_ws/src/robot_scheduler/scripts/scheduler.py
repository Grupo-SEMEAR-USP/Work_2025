...
class Scheduler:
    def __init__(self):
        ...
        self.plan = [
            ...
            # ("manipulation",     "arm,deposit_to_top",   False,  10.0),
            # ("manipulation",     "rotatory_base,deposit2_to_front_left",   False,  7.0),
            ...
            # ("align_table", "10", True, 15),
            ("move", "parar", False, 1),
            ("search_block",      "6,direita", True, 60),
            ("move", "parar", False, 1),
            # ("align_table", "10", True, 15),
            ("move", "parar", False, 1),
            ...
            # ("align_table", "10", True, 15),
            ("move", "parar", False, 1),
            ("search_block",      "5,direita", True, 60),
            ("move", "parar", False, 1),
            ("search_block",      "1,direita", True, 60),
            ("move", "parar", False, 1),
            ("search_block",      "3,direita", True, 60),
            ("move", "parar", False, 1)
