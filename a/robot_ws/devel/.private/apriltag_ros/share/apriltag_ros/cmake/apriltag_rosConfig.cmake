...
if("TRUE" STREQUAL "TRUE")
  set(apriltag_ros_SOURCE_PREFIX /home/rmajetson/Work_2025/a/robot_ws/src/apriltag_ros/apriltag_ros)
  set(apriltag_ros_DEVEL_PREFIX /home/rmajetson/Work_2025/a/robot_ws/devel/.private/apriltag_ros)
  ...
  set(apriltag_ros_INSTALL_PREFIX /home/rmajetson/Work_2025/a/robot_ws/install)
...
if(NOT "/home/rmajetson/Work_2025/a/robot_ws/devel/.private/apriltag_ros/include;/home/rmajetson/Work_2025/a/robot_ws/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/home/rmajetson/catkin_ws/devel/include;/home/rmajetson/catkin_ws/devel/include/apriltag;/usr/include/opencv4 " STREQUAL " ")
  set(apriltag_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/rmajetson/Work_2025/a/robot_ws/devel/.private/apriltag_ros/include;/home/rmajetson/Work_2025/a/robot_ws/src/apriltag_ros/apriltag_ros/include;/usr/include/eigen3;/home/rmajetson/catkin_ws/devel/include;/home/rmajetson/catkin_ws/devel/include/apriltag;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltag_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rmajetson/Work_2025/a/robot_ws/src/apriltag_ros/apriltag_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(apriltag_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "apriltag_ros_common;apriltag_ros_continuous_detector;apriltag_ros_single_image_detector;-lpthread;m;/usr/lib/aarch64-linux-gnu/libopencv_calib3d.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_core.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_dnn.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_features2d.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_flann.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_gapi.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_highgui.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_ml.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_objdetect.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_photo.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_stitching.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_video.so.4.5.4;/usr/lib/aarch64-linux-gnu/libopencv_videoio.so.4.5.4")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(apriltag_ros_EXPORTED_TARGETS ${${apriltag_ros_dep}_EXPORTED_TARGETS})
endforeach()
